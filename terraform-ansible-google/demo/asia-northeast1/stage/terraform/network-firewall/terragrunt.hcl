...
terraform {
  source = "github.com/tkam8/f5_cis_scalen_modules//gcp_network_firewall?ref=v0.1"
}
...
dependency "vpc" {
  ...
  mock_outputs = {
    ...
    private_subnetwork2      = "https://www.googleapis.com/compute/v1/projects/f5-gcs-4261-sales-apcj-japan/regions/asia-northeast1/subnetworks/mock-subnet3"
    public_subnetwork_cidr_block             = "10.1.10.0/24"
    private_subnetwork2_cidr_block           = "10.1.11.0/24"
    ...
    private_subnetwork2_secondary_cidr_block = "192.168.12.0/24"
  }
