...
dependency "bigip1" {
  config_path = "../functions/bip_ecmp"
...
inputs = {
  ...
  bigip1_public_ip             = dependency.bigip_ecmp.outputs.f5_public_ip
  bigip1_private_ip            = dependency.bigip_ecmp.outputs.f5_private_ip
}
